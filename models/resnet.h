...
namespace model {
    namespace resnet {
        ...
        private:
            ...
            torch::nn::BatchNorm2d bn1_, bn2_;
        ...
        private:
            ...
            torch::nn::BatchNorm2d bn1_, bn2_, bn3_;
            torch::nn::Sequential downsample_{ nullptr };
        };
        ...
        public:
            ResNet18Impl(int num_classes = 1000, bool zero_init_residual = false) : ResNetImpl("BasicBlock", { 2, 2, 2, 2 }, num_classes, zero_init_residual) { name = "ResNet18"; };
        };
        ...
        public:
            ResNet34Impl(int num_classes = 1000, bool zero_init_residual = false) : ResNetImpl("BasicBlock", { 3, 4, 6, 3 }, num_classes, zero_init_residual) { name = "ResNet34"; };
        };
        ...
        public:
            ResNet50Impl(int num_classes = 1000, bool zero_init_residual = false) : ResNetImpl("Bottleneck", { 3, 4, 6, 3 }, num_classes, zero_init_residual) { name = "ResNet50"; };
        };
        ...
        public:
            ResNet101Impl(int num_classes = 1000, bool zero_init_residual = false) : ResNetImpl("Bottleneck", { 3, 4, 23, 3 }, num_classes, zero_init_residual) { name = "ResNet101"; };
        };
        ...
        public:
            ResNet152Impl(int num_classes = 1000, bool zero_init_residual = false) : ResNetImpl("Bottleneck", { 3, 8, 36, 3 }, num_classes, zero_init_residual) { name = "ResNet152"; };
        };
        ...
        public:
            ResNext50_32x4dImpl(int num_classes = 1000, bool zero_init_residual = false) : ResNetImpl("Bottleneck", { 3, 4, 6, 3 }, num_classes, zero_init_residual, 32, 4) { name = "ResNet18"; };
        };
        ...
        public:
            ResNext101_32x8dImpl(int num_classes = 1000, bool zero_init_residual = false) : ResNetImpl("Bottleneck", { 3, 4, 23, 3 }, num_classes, zero_init_residual, 32, 8) { name = "ResNet18"; };
        };
